# it would track  the difference b/w image & video, 
# with the help of countour we define that track anything biigetbigger than 10000 pixel which is a big body, not the leaves.
import cv2
