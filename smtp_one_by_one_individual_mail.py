...
email = 'ankanmazumdar2016@gmail.com'
password = '8910651838'
send_to_emails = ['ankanmazumdar2016@gmail.com', 'rocksankan@gmail.com'] # List of email addresses
subject = 'This mail to be sent invidually to receipients'
message = 'ankanva o milega to rocksankan nahi dekh payega aur vice-versa'
