...
temp2 = f"this is a {name2} and he is a good boy named {name1}" #python community comeup with thissyntax as neasier way for format function
print(temp1)
print(temp2)
...
# Tuple
a = ("Harry", "Shubh", "Rohan")
b = list(a)# we can edit elements of a tuple by type casting it into list.
# Cannot do this
# a[0] = "Vikrant" #TypeError: 'tuple' object does not support item assignment
b[0] = "Vikrant"
print(a)
print(b)
print(type(a))
...
# s1.add(44444) # add for adding one element
# s1.update([12,12,423,3423,634,123,432,23])
# print(len(s1)) #update for adding multiple elements
# s1.remove(1666) #remove will throw error if the element doesnt exist
# Like list you can use: .pop, .clear, del
# and.. intersection, union
# s1.discard(1666) # discard will removethe element when its present else discard and dont throw an error
# print(s1)

#dictionary- it is same like a English to Hindi dictionary where each english keyword has as hindi word value as a pair.
harryDict = {
    "Name": "Harry",
    "Class": "4th",
    "Marks": 34.34,
